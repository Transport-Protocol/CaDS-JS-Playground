	...
	app.use(
  		helmet({
    		contentSecurityPolicy: {
      			useDefaults: false,
      			directives: { 
			   defaultSrc: ["'self'", "cads.informatik.haw-hamburg.de","youtube.com", "youtu.be","maps.google.com", "www.youtube.com"],
			   frameSrc: ["'self'", "cads.informatik.haw-hamburg.de","youtube.com", "youtu.be","www.youtube.com","maps.google.com"],
